...
class Game(Widget):
    ...
    def cambiarPista(self):
        global colorPista
        print(f"Antes: {colorPista}")
        colorPista+=1
        print(f"Despues: {colorPista}")
    ...
    def mostrar_menu(self):
        ...
        self.mejor_puntaje_contorno.pos = (self.width/2-self.start_button.width/3, self.height/2+self.mejor_puntaje.height*2)
    ...
    def ocultarMenu(self):
        ...
        self.mejor_puntaje_contorno.pos = (-500, -500)
...
class GameApp(App):
    def build(self):
        ...
        game.mejor_puntaje_contorno = game.ids.puntajeContorno_label
