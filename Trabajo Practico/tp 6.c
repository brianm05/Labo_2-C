...
int confimar(){
    ...
    if(eleccion=='S' || eleccion=='s'){
        ...
        printf("No se completo la accion.\n");
        return 0;
    }
}
...
int mayorQueCero(){
    ...
    fflush(stdin);
    while(num<=0){
        printf("El numero ingresado debe ser mayor que 0.\n");
...
void bajaLogica(){
    ...
    printf("%cQue numero de orden quiere dar de baja logica?\n",168);
    datos.orden=mayorQueCero();
